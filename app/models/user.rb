class User < ApplicationRecord
  ...
  has_and_belongs_to_many :positions, join_table: "positions_users"
  has_and_belongs_to_many :teams, join_table: "teams_users"
  has_many :departments, :through => :teams
  ...
  accepts_nested_attributes_for :user_attachments, :allow_destroy => true, :reject_if => :all_blank
  accepts_nested_attributes_for :report, reject_if: :all_blank
