...
Gem::Specification.new do |s|
  ...
  s.summary = "SixArm.com \u{2192} Ruby \u{2192} Unaccent"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<sixarm_ruby_minitest_extensions>, ["= 1.0.5"])
      ...
      s.add_dependency(%q<sixarm_ruby_minitest_extensions>, ["= 1.0.5"])
